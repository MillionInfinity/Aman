...
<header id="my-header">
        <div class="navbar navbar-expand-lg navbar-light bg-light">
         ...
         <a class="navbar-brand orn" href="#"><img src="./../imgs/logoflower2.png" width="38" height="35" class="d-inline-block align-top" alt="">Ornella Multi-Media</a>     
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
        <ul class="collapse navbar-collapse navfont" id="navbarText">
                    <ul class="navbar-nav mr-auto">
                            <li class="nav-item active"><a class="nav-link n1" href="index.html">Home <span class="sr-only">(current)</span></a></li>
                            <li class="nav-item"><a class="nav-link n2" href="aman.html">Aman</a></li>
                            <li class="nav-item"><a class="nav-link n3" href="gallery.html">Gallery</a></li>
                            <li class="nav-item"><a class="nav-link n4" href="http://localhost/ornella/OrnellaMedia/contactme.php">Contact Us</a></li>
                            <li class="nav-item"><a class="nav-link n4" href="branch.html">Branch</a></li>
                    </ul>
                     <div class="central-nav">
                        <a href="index.html"><img src="./../imgs/logoflower2.png" class="img-fluid" alt="ornella logo" width="150px"></a>
                        <div class="orn">Ornella Multi-Media</div>
                        <div class="creative">Creative Photographer and Videographer</div>
                   </div> 
                    <div class="navbar navbar-expand-sm bg-light justify-content-center"></div>
...
const footer = () => {
    let footerh = `<div class="nav footer">
               <div class=""></div>
                 <div class="fi">
                <img src="./../imgs/logoflower2.png" alt="textlogo" width="150px">
                </div>
